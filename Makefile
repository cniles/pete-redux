...
CFLAGS=-g -std=c99
TARGET=pete
OBJS=petemain.o level.o tileset.o texture.o player.o animation.o gamestate.o zombie.o bat.o soul.o gameobject.o physicsobject.o statemachineobject.o bullet.o
LINK=g++ $(CPPFLAGS)
#LINK=gcc $(CFLAGS)
